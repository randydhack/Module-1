...
/*
1. Create a condition to so you have a stopping point so you dont run into stack overflow.
2. Inside that if statement, create a base case that b equals to 0 and return 1.
3. return b * advance(b, n - 1) so n is always going towards the base case.
*/
